...
var pMode=localStorage.getItem('posterMode')||'smart';
    ...
    try{
        ...
        d.results.forEach(f=>{
            ...
            if(pMode!=='none'){
                ...
                imgHtml=`<div class="poster-box"><img src="${imgSrc}" class="fc-poster" onerror="this.src='https://i.ibb.co/30B3RcS/default-movie.png'"></div>`;
            }
            
            // नया कार्ड लेआउट (Top -> Bottom)

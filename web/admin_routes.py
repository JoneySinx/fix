...
function handleLocalPreview(input) {
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            // ✂️ YouTube Studio मैकेनिज्म (फ्रेम लॉक रहेगा, इमेज अंदर ड्रैग और पिंच-ज़ूम होगी)
            cropperInstance = new Cropper(imageElement, {
                aspectRatio: 16 / 9,
                viewMode: 1,         // इमेज फ्रेम की बाउंड्री से बाहर खाली नहीं जाएगी
                dragMode: 'move',    // डिफ़ॉल्ट रूप से माउस/टच से इमेज मूव होगी
                background: false,
                autoCropArea: 1,     // क्रॉप बॉक्स पूरे 16:9 एरिया को कवर रखेगा
                restore: false,
                guides: false,       // गाइडलाइन्स ऑफ (Studio लुक)
                center: true,
                highlight: false,
                cropBoxMovable: false,   // 🔒 क्रॉप फ्रेम पूरी तरह लॉक रहेगा
                cropBoxResizable: false, // 🔒 फ्रेम का साइज चेंज नहीं हो सकता
                toggleDragModeOnDblclick: false,
                zoomable: true,      // 📱 मोबाइल पिंच-ज़ूम और व्हील ज़ूम इनेबल
                movable: true        // 🔄 इमेज ड्रैगिंग इनेबल
            });
        };
...
async function saveAllChanges() {
    ...
    try {
        // स्टेप 1: अगर एडमिन ने इमेज एडजस्ट की है, तो क्रॉप डेटा निकालें
        if (cropperInstance) {

...
var pMode=localStorage.getItem('posterMode')||'tg'; // TMDb removed, default tg
...
async function doSearch(o){
    ...
    try{
        ...
        d.results.forEach(f=>{
            ...
            var imgHtml='';
            if(pMode!=='none'){
                imgHtml=`<div class="poster-box"><img src="${f.poster}" class="fc-poster" onerror="this.src='https://i.ibb.co/30B3RcS/default-movie.png'"></div>`;
            }
...
async def dash(req):
    ...
    # ✅ FIX: TMDb option removed from select dropdown
